...
-- This script creates sample data for a specific user ID
-- Usage: Replace 'YOUR-USER-ID-HERE' with the actual UUID of the user
...
-- Replace 'YOUR-USER-ID-HERE' with the actual UUID of the user
SELECT create_demo_data_for_user('YOUR-USER-ID-HERE');
